...
<nav>
    <ul>
        ...
        <li class="deep"><a href="admin_find.php">物品流动信息</a></li>
...
<div class="f"><font><center>物品流动信息</center></font></div>
<!-- 引入 jQuery 库 -->
...
<div id="content">
    <table id="myTable" style="width: 80%; border: 1px solid black; margin: auto; text-align: center; vertical-align: middle;">
        ...
        // 从数据库获取符合条件的物品
        $sql = "SELECT * FROM history LIMIT {$start_record}, {$page_size}";
        $result = mysqli_query($conn, $sql);
    ...
    <script>
        ...
        var totalPages = <?php echo ceil(mysqli_num_rows(mysqli_query($conn, "SELECT * FROM history"))/5); ?>;
